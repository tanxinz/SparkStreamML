...
// class MACAction extends ScalatraServlet with JacksonJsonSupport with ESQueryTrait with IPropertiesTrait{

  // // Sets up automatic case class to JSON output serialization, required by
  // // the JValueResult trait.
  // protected implicit lazy val jsonFormats: Formats = DefaultFormats
  //
  // case class MAC(mac:String,important:String)//,imsi:String,imei:String,szt:String,important:String)
  //
  ...
  //           .endObject()
  //       ESUpsert(MACINDEX,ESTYPE,mac("mac"),body)
  //     }.isSuccess
  //   if(ok) "ok!"
...
class MACAction extends HBaseActionTrait{
